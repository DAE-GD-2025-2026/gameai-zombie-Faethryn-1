...
#include "BTD_AnyFoodInMemoryFaeMuylle.h"
...
bool UBTD_AnyFoodInMemoryFaeMuylle::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
