...
#include "BTT_CheckForFoodFaeMuylle.h"
...
EBTNodeResult::Type UBTT_CheckForFoodFaeMuylle::ExecuteTask(UBehaviorTreeComponent& root, uint8* nodeMemory)
{
	...
	if (myPerceptorMuylleFae->SeenFoods.Num() > 0)
	{
