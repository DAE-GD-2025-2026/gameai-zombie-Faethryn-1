...
#include "SurvivorMovementFaeMuylle.generated.h"
...
class MUYLLEFAEZOMBIERUNTIME_API USurvivorMovementFaeMuylle : public UActorComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	USurvivorMovementFaeMuylle();
	
	virtual ~USurvivorMovementFaeMuylle() override;
